...
- Domain vocabulary is maintained in `CONTEXT.md` at the repo root; architectural decisions referenced above are recorded as ADR-0001 through ADR-0008 in `docs/adr/`.
